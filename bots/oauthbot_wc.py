...
def test_join_channel(client):
    channel_id = "ccb01dc22bb14c47a37b66deb15e0b75"  # test-jx
    join_channel_response = client.chat_channels.join(channel_id=channel_id)
    print("------------------------------")
    print(join_channel_response)
    print("------------------------------")


def test_leave_channel(client):
    channel_id = "ccb01dc22bb14c47a37b66deb15e0b75"  # test-jx
    leave_channel_response = client.chat_channels.leave(channel_id=channel_id)
    print("------------------------------")
    print(leave_channel_response)
    print("------------------------------")


def test_remove_member(client):
    channel_id = "b0de2e90ef3f443398e541371398ead2"  # test-jx-2
    member_id = "gIJMg4HrQOe6sHhXvubE3w"  # junxian.chen@uci.edu
